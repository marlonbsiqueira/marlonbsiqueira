document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        en: {
            ...
            hero_available: "Based in Porto, Portugal",
            ...
            num_initiatives:   "Automation solutions",
            ...
            bring_3_text:  "I build the solutions myself — not as a project sponsor, not as a requirements writer. When a process needs automation, I design the architecture, write the code, validate the output and support adoption. I integrate AI tools (Copilot, generative AI) as practical accelerators across every stage of delivery. This combination of finance depth and hands-on technical execution is what makes transformation sustainable.",
            ...
            hl_1_title:    "Large-Scale Communications Automated Across Europe",
            hl_1_challenge:"A critical regulatory transition required large-scale communications across multiple European countries — with full GDPR compliance, audit traceability and zero operational disruption.",
            ...
            hl_1_outcome:  "Communications delivered at scale across Europe. Zero operational disruption. Full audit trail. Template adopted as the standard for future regulatory transition programmes.",
            ...
            stellantis_li3:"Deployed large-scale automated communications across Europe for a critical regulatory transition — GDPR-compliant, zero disruption; accelerated financial close from 8 to 6 days",
            current_role:  "Current Role",
            fyi_li1:       "Delivered finance and digital transformation consulting engagements — bridging financial process expertise with digital innovation solutions for mid-to-large organisations across Brazil",
            fyi_li2:       "Applied automation and analytics tools to redesign financial workflows — reducing manual effort and increasing reporting speed and data accuracy for client finance teams",
            fyi_li3:       "Operated at the intersection of finance and technology — translating complex operational requirements into structured, scalable digital solutions ahead of transition to multinational SSC/GBS environments in Europe",
            ...
            auto_skill_1:  "RPA · Automation Anywhere · Blue Prism",
            auto_skill_2:  "Microsoft Power Platform · Power Automate",
            auto_skill_3:  "Python & VBA · Scripting & Macros",
            ...
            dash_skill_1:  "Power BI & Advanced DAX",
            dash_skill_2:  "Data Modelling & Visualisation",
            dash_skill_3:  "SAP Data Extraction & Pipelines",
            ...
            mensa_desc:    "Admitted to Mensa Brasil in May 2014 after scoring at the 98th percentile or above on a standardised intelligence test validated by the Conselho Federal de Psicologia. Mensa is the largest high-IQ society in the world, open exclusively to individuals who score in the top 2% of the population.",
            mensa_badge:   "98th Percentile · Since 2014",
        ...
        pt: {
            ...
            nav_cta:           "Vamos Falar",
            hero_available: "Sediado no Porto, Portugal",
            ...
            num_initiatives:   "Soluções de automação",
            ...
            hl_1_title:    "Comunicações Automatizadas à Escala na Europa",
            hl_1_challenge:"Uma transição regulatória crítica exigiu comunicações em larga escala em vários países europeus — com total conformidade GDPR, rastreabilidade para auditoria e zero perturbação operacional.",
            ...
            hl_1_outcome:  "Comunicações entregues à escala na Europa. Zero perturbação operacional. Rastro de auditoria completo. Modelo adotado como padrão para futuros programas de transição regulatória.",
            ...
            stellantis_li3:"Implementei comunicações automatizadas em larga escala na Europa para uma transição regulatória crítica — GDPR-compliant, zero perturbação; fecho financeiro acelerado de 8 para 6 dias",
            current_role:  "Função Atual",
            fyi_li1:       "Prestou consultoria de transformação financeira e digital — articulando expertise em processos financeiros com soluções de inovação digital para organizações de médio e grande porte no Brasil",
            fyi_li2:       "Aplicou ferramentas de automação e analytics para redesenhar fluxos financeiros — reduzindo trabalho manual e aumentando a velocidade e precisão de reporte para equipas financeiras de clientes",
            fyi_li3:       "Operou na interseção entre finanças e tecnologia — traduzindo requisitos operacionais complexos em soluções digitais escaláveis antes da transição para ambientes SSC/GBS multinacionais na Europa",
    ...
    /* ══════════════════════════════════════════════
       ...
       crawlers and no-JS environments read the real numbers. The JS
       only animates from a lower number up to the target on scroll.
    ══════════════════════════════════════════════ */
    ...
    const animateCounter = (el) => {
        ...
        // If the user prefers reduced motion, leave the static HTML value intact.
        if (reduced) { return; }
    ...
    ══════════════════════════════════════════════ */
    const mensaCertImg = document.querySelector(".mensa-cert img");
    if (mensaCertImg) {
        ...
        mensaCertImg.setAttribute("aria-label", "Click to expand certificate");
