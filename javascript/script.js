document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        en: {
            brand_subtitle:    "Finance Transformation · SAP · Automation",
            nav_home:          "Home",
            nav_highlights:    "Highlights",
            nav_experience:    "Experience",
            nav_deliver:       "Core Capabilities",
            nav_skills:        "Skills",
            nav_cta:           "Start a conversation",

            hero_eyebrow:      "Finance Transformation · SAP · Automation · SAP S/4HANA · Automation · AI",
            hero_line1:        "I Deliver Finance Transformation",
            hero_accent1:      "Built for Scale, Control and Measurable Impact.",
            ...
            hero_description:  "12+ years of international experience across Europe and Latin America — delivering SAP S/4HANA-enabled transformation, intelligent automation and advanced analytics in multinational SSC/GBS environments. I bridge finance, IT and operations to turn complexity into controlled, scalable and audit-ready outcomes.",
            hero_cta_primary:  "See Selected Impact",
            hero_cta_secondary:"Explore Experience",

            num_savings:       "Productivity savings generated",
            num_fte:           "Direct efficiency impact",
            num_initiatives:   "Automation solutions delivered",
            num_leaders:       "Senior stakeholders served",
            num_entities:      "European entities supported",

            deliver_title:   "Core Capabilities",
            deliver_subtitle:"The combination I bring to transformation programmes: finance depth, process discipline and hands-on technical delivery.",
            bring_1_title: "Finance Governance",
            bring_1_text:  "I strengthen finance operations so they are controlled, audit-ready and decision-oriented. My work spans financial controls, month-end close, reporting governance, IFRS alignment and multi-jurisdiction complexity — improving reliability while giving leadership better visibility.",
            bring_1_li1:   "Close acceleration and reporting governance",
            bring_1_li2:   "Multi-country compliance and control frameworks",
            bring_1_li3:   "Executive KPI design and performance visibility",
            bring_1_li4:   "Cost intelligence, forecasting and variance analysis",
            bring_2_title: "Process Transformation",
            bring_2_text:  "I redesign processes across R2R, P2P and OTC with a clear focus on control, efficiency and adoption. Lean Six Sigma provides the discipline, but the goal is business impact: fewer bottlenecks, clearer handoffs, shorter cycle times and more resilient operations.",
            bring_2_li1:   "Process redesign using DMAIC and Value Stream Mapping",
            bring_2_li2:   "Cross-functional redesign at SSC/GBS scale",
            bring_2_li3:   "Structured problem-solving and standardisation",
            bring_2_li4:   "R2R, P2P and OTC cycle-time reduction",
            bring_3_title: "Automation & Analytics Delivery",
            bring_3_text:  "I translate transformation priorities into working solutions — automation, dashboards, controls and SAP-enabled improvements. I build, test and validate the output directly, integrating AI tools where useful to accelerate documentation, development and communication.",
            bring_3_li1:   "RPA and workflow automation delivery",
            bring_3_li2:   "Executive dashboards and advanced DAX modelling",
            bring_3_li3:   "SAP S/4HANA UAT and post-go-live optimisation",
            bring_3_li4:   "VBA, Python, Power Automate and SQL execution",

            hl_title:      "Career Highlights",
            hl_subtitle:   "Three examples of how I convert finance complexity into controlled, measurable business outcomes.",
            ...
            stellantis_li1:"Driving finance transformation across 15+ European entities within Stellantis' SSC/GBS — combining SAP S/4HANA, intelligent automation and analytics to deliver controlled, scalable and audit-ready outcomes.",
            stellantis_li2:"Led delivery of 20+ automation solutions (RPA, VBA, Power Platform) — ~9 FTE direct efficiency impact; built 15+ Power BI dashboards improving KPI visibility by 40–50% for 70+ senior stakeholders.",
            stellantis_li3:"Led UAT and post-go-live optimisation within SAP finance transformation; executed 200,000+ automated communications across Europe with zero disruption and helped reduce close from 8 to 6 days.",
            current_role:  "Current Role",
            renova_tag:    "Social Programs · Brazil",
            renova_li1:    "Delivered financial governance across a R$11B+ annual portfolio spanning 40+ cost centres within one of Brazil's largest socio-environmental recovery programmes.",
            renova_li2:    "Implemented SAP procurement controls and automated reporting solutions — reducing manual reporting time by 40–60% and rework by 50%.",
            renova_li3:    "Enabled financial transparency and control across a multi-stakeholder programme under intense institutional and public scrutiny.",
            meridian_tag:  "Tax & Compliance · Europe",
            meridian_li1:  "Led VAT compliance and reclaim across 30+ EU jurisdictions for 15+ multinational clients, including major technology companies — achieving 100% audit success with zero adjustments.",
            meridian_li2:  "Analysed cross-border transactions to assess VAT recovery eligibility and support compliant, optimised transaction structures.",
            meridian_li3:  "Provided multi-country indirect tax advisory through regulatory interpretation and structured client support.",
            ale_tag:       "Fuel Distribution & Finance · Brazil",
            ale_li1:       "Developed end-to-end cost models across 40+ national fuel distribution bases — enabling strategic pricing decisions on multi-billion-litre annual volumes.",
            ale_li2:       "Built the company's first structured historical cost database — identifying a previously invisible zero-margin operation and contributing to ~20–30% storage cost reduction.",
            ale_li3:       "Contributed to 15–20% cost reduction across 5 business units through data-driven optimisation and analytical decision support.",
            vale_tag:      "Mining & Operations · Brazil",
            vale_li1:      "Supported continuous improvement initiatives across mining, logistics and administrative operations using Lean, 5S, Kaizen, PDCA and Six Sigma methodologies.",
            vale_li2:      "Contributed to process standardisation and operational efficiency initiatives within complex industrial environments.",

            auto_title:    "Automation",
            auto_subtitle: "Reducing manual workload while strengthening control, traceability and delivery speed.",
            auto_text:     "I use automation to remove repetitive effort without compromising governance. That means fixing the process first, then selecting the right delivery approach — RPA, VBA, Power Platform, Python or AI-assisted workflow design. The result is not just faster execution, but stronger control, better traceability and more capacity for finance teams to focus on analysis and decision support.",

            ci_title:    "Continuous Improvement",
            ci_subtitle: "Lean disciplines applied to real operating environments — reducing friction, waste and cycle time.",
            ci_text:     "Continuous improvement is the operating discipline behind my transformation work. I use Lean Six Sigma tools to diagnose bottlenecks, redesign handoffs and embed more robust ways of working across finance and operations. The objective is durable performance improvement — not one-off fixes, but standards, controls and behaviours that sustain gains after delivery.",

            skills_title:    "Capabilities & Tools",
            skills_subtitle: "Business capabilities first; tools second.",
            ...
            contact_title:    "Discuss a Transformation Challenge",
            contact_subtitle: "Open to conversations around Finance Transformation, SAP-enabled change, automation and analytics in multinational environments.",
        ...
        pt: {
            brand_subtitle:    "Transformação Financeira · SAP · Automação",
            nav_home:          "Início",
            nav_highlights:    "Destaques",
            nav_experience:    "Experiência",
            nav_deliver:       "Capacidades Principais",
            nav_skills:        "Competências",
            nav_cta:           "Iniciar conversa",

            hero_eyebrow:      "Transformação Financeira · SAP · Automação · SAP S/4HANA · Automação · IA",
            hero_line1:        "Entrego Transformação Financeira",
            hero_accent1:      "com escala, controlo e impacto mensurável.",
            ...
            hero_description:  "12+ anos de experiência internacional na Europa e América Latina — entregando transformação SAP S/4HANA, automação inteligente e analytics avançado em ambientes multinacionais de SSC/GBS. Faço a ponte entre finanças, IT e operações para transformar complexidade em resultados controlados, escaláveis e auditáveis.",
            hero_cta_primary:  "Ver impacto selecionado",
            hero_cta_secondary:"Explorar experiência",

            num_savings:       "Poupança de produtividade gerada",
            num_fte:           "Impacto direto em eficiência",
            num_initiatives:   "Soluções de automação entregues",
            num_leaders:       "Stakeholders seniores apoiados",
            num_entities:      "Entidades europeias apoiadas",

            deliver_title:   "Capacidades Principais",
            deliver_subtitle:"A combinação que levo para programas de transformação: profundidade financeira, disciplina de processo e execução técnica prática.",
            bring_1_title: "Governação Financeira",
            bring_1_text:  "Reforço operações financeiras para que sejam controladas, prontas para auditoria e orientadas para decisão. O meu trabalho cobre controlos financeiros, fecho mensal, governação de reporting, alinhamento IFRS e complexidade multi-jurisdição — aumentando fiabilidade e visibilidade para a liderança.",
            bring_1_li1:   "Aceleração do fecho e governação de reporting",
            bring_1_li2:   "Frameworks de controlo e compliance multi-país",
            bring_1_li3:   "KPIs executivos e visibilidade de performance",
            bring_1_li4:   "Inteligência de custos, forecasting e análise de desvios",
            bring_2_title: "Transformação de Processos",
            bring_2_text:  "Redesenho processos em R2R, P2P e OTC com foco claro em controlo, eficiência e adoção. O Lean Six Sigma dá disciplina, mas o objetivo é impacto de negócio: menos gargalos, handoffs mais claros, tempos de ciclo menores e operações mais resilientes.",
            bring_2_li1:   "Process redesign using DMAIC and Value Stream Mapping",
            bring_2_li2:   "Redesenho cross-funcional de processos em escala SSC/GBS",
            bring_2_li3:   "Resolução estruturada de problemas e standardização",
            bring_2_li4:   "Redução de tempos de ciclo em R2R, P2P e OTC",
            ...
            skills_title:    "Capacidades & Ferramentas",
            skills_subtitle: "Primeiro as capacidades de negócio; depois as ferramentas.",
            ...
            contact_title:    "Discutir um desafio de transformação",
            contact_subtitle: "Disponível para conversas sobre Transformação Financeira, mudança suportada por SAP, automação e analytics em ambientes multinacionais.",
            ...
            footer_tagline: "Transformação Financeira · SAP S/4HANA · Automação · Analytics",
